...
# La cuenta `microstreaming` y el repo `microstreaming.github.io` tienen
# el mismo nombre, asi que Pages lo sirve como sitio de usuario, en la
# raiz del subdominio.
#
# Para generar con otra URL sin tocar codigo:
#   MS_BASE=https://otra-url python build.py
BASE_DEFAULT = "https://microstreaming.github.io"
